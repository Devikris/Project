...
model_path = os.path.join(base_dir, 'mlp_model_declined_benchpress.pkl')
label_encoder_path = os.path.join(base_dir, 'label_encoder_declined_benchpress.pkl')
...
if os.path.exists(model_path) and os.path.exists(label_encoder_path):
    ...
    raise FileNotFoundError("One or both .pkl files are missing for Declined Bench Press.")
...
# Debugging - Track changes after execution
                    ...
                    if "Great form! You're reaching the top range!" in predicted_feedback:
                        correct_count += 1
                    elif "Perfect declined bench press form!" in predicted_feedback:
                        correct_count += 1

...
model_path = os.path.join(base_dir, 'mlp_model_hammercurl.pkl')
label_encoder_path = os.path.join(base_dir, 'label_encoder_hammercurl.pkl')
...
if os.path.exists(model_path) and os.path.exists(label_encoder_path):
    ...
    raise FileNotFoundError("One or both .pkl files are missing for Hammer Curls.")

...
model_path = os.path.join(base_dir, 'mlp_model_barbell_benchpress.pkl')
label_encoder_path = os.path.join(base_dir, 'label_encoder_barbell_benchpress.pkl')
...
if os.path.exists(model_path) and os.path.exists(label_encoder_path):
    ...
    raise FileNotFoundError("One or both .pkl files are missing for Barbell Bench Press.")
...
# Debugging - Track changes after execution
                    ...
                    if "Great form! You're reaching the top range!" in predicted_feedback:
                        correct_count += 1
                    elif "Perfect barbell bench press form!" in predicted_feedback:
                        correct_count += 1

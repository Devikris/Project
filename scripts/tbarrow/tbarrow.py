...
model_path = os.path.join(base_dir, 'mlp_model_tbar.pkl')
label_encoder_path = os.path.join(base_dir, 'label_encoder_tbar.pkl')
...
if os.path.exists(model_path) and os.path.exists(label_encoder_path):
    ...
    raise FileNotFoundError("One or both .pkl files are missing for T-Bar Row.")
...
# Debugging - Track changes after execution
                    ...
                    if "Great form! You're reaching the top range!" in predicted_feedback:
                        correct_count += 1
                    elif "Perfect T-bar row form!" in predicted_feedback:
                        correct_count += 1
